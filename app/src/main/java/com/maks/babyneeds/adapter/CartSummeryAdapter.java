 ...
 */
public class CartSummeryAdapter extends RecyclerView.Adapter<CartSummeryAdapter.ViewHolder> {

    PlaceOrderActivity context;
    OnItemClickListener mItemClickListener;
    //List of Category
    List<ShoppingCart> shoppingCart;


    public CartSummeryAdapter(List<ShoppingCart> shoppingCart, PlaceOrderActivity context){
        super();
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
       ...
       holder.textViewName.setText(cart.getProduct().getProduct_name());
        ...
        holder.textQuantity.setText("Qty : "+cart.getQuantity());
