...
import com.maks.babyneeds.Activity.WhatsNewActivity;
...
public class NewProductAdapter extends RecyclerView.Adapter<NewProductAdapter.ViewHolder> {
    ...
    private WhatsNewActivity context;
    OnItemClickListener mItemClickListener;
    //List of Category
    List<Product> Category;
    Activity activity;

    public NewProductAdapter(List<Product> Category, WhatsNewActivity context){
        super();
