...
import com.maks.babyneeds.Activity.RecommendedActivity;
...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.ViewHolder> {
    ...
    private RecommendedActivity context;
    OnItemClickListener mItemClickListener;
    //List of Category
    List<Product> Category;
    Activity activity;

    public RecommendedAdapter(List<Product> Category, RecommendedActivity context){
        super();
