...
import com.maks.babyneeds.adapter.RecommendedAdapter;
...
public class RecommendedActivity extends AppCompatActivity implements ProductAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecommendedAdapter(listProducts, RecommendedActivity.this);
    ...
    class ProductTask extends AsyncTask<String, Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd= new ProgressDialog(RecommendedActivity.this);
    ...
    private void getData(){
        new ProductTask().execute(Constants.WS_URL,"{\"method\":\"get_recommended\"}");
    }
